...
RUN git clone https://github.com/ageron/handson-ml3.git
WORKDIR /home/enthu/handson-ml3
...
EXPOSE 8888
#CMD ["conda", "run", "-n", "homl3", "jupyter", "lab", "--ip=0.0.0.0", "--port=8888", "--no-browser", "--NotebookApp.token=''"]
